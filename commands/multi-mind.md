...
Execute a multi-specialist collaborative analysis using independent Opus subagents.
...
Each subagent operates independently with access to WebSearch, Read, and analysis tools. Always use Opus subagents. 
